...
public class DuratorTest {
    ...
    public void setUp() throws Exception {
        URL urlCart = getClass().getResource("/com/sun/speech/freetts/en/us/durz_cart.txt");
        CARTImpl cart = new CARTImpl(urlCart);
        URL urlPhones = getClass().getResource("/com/sun/speech/freetts/en/us/dur_stat.txt");
